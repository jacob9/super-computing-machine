...
namespace Slave.Util
{
    class PasswordFileHandler
    {
        ...
        public static List<ClientUserInfo> ReadPasswordFile(String filename)
        {
            List<ClientUserInfo> result = new List<ClientUserInfo>();
            ...
            using (StreamReader sr = new StreamReader(fs))
            {
                ...
                while (!sr.EndOfStream)
                {
                    ...
                    ClientUserInfo userInfo = new ClientUserInfo(parts[0], parts[1]);
                    result.Add(userInfo);
                }
                return result;
            }
